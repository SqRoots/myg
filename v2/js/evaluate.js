...
function getDataFromForm(){
  ...
  var ann_input = [];
  ann_input.push(ann_input_dict["ifn"]);
  ann_input.push(ann_input_dict["combined"]);
  ann_input.push(ann_input_dict["age"]);
  ann_input.push(ann_input_dict["alt"]);
  ann_input.push(ann_input_dict["ast"]);
  ann_input.push(ann_input_dict["glo"]);
  ann_input.push(ann_input_dict["alp"]);
  ann_input.push(ann_input_dict["hbeag"]);
  return ann_input;
}
...
function setForm() {
  ...
  $('#arg_ifn').val(getUrlParam('ifn')||'');
  $('#arg_alt').val(getUrlParam('alt')||'');
  $('#arg_ast').val(getUrlParam('ast')||'');
  $('#arg_glo').val(getUrlParam('glo')||'');
  $('#arg_alp').val(getUrlParam('alp')||'');
  $('#arg_combined').val(getUrlParam('combined')||'');
